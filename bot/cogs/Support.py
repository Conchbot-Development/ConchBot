...
class Support(commands.Cog):
    ...
    async def support(self, ctx):
        ...
        embed.add_field(name="You Just Used the Support Command!",
                        value="This means you either have a question about ConchBot,"
                              " would like to report an error or bug, or just want to join the ConchBot community!")
        embed.add_field(name="ConchBot Discord Server",
                        value="You can join ConchBot's support server [here](https://discord.gg/PyAcRfukvc)")
        embed.add_field(name="Or, if you don't want to join a server...",
                        value="You can submit bugs or errors via 'cb report {description of bug}.")
    ...
    async def invite(self, ctx):
        ...
        embed.add_field(name="ConchBot Invite:", value="You can invite ConchBot to your server "
                                                       "[here](https://discord.com/api/oauth2/authorize?client_id"
                                                       "=890362614155194428&permissions=2348927041&scope=applications"
                                                       ".commands%20bot)")
