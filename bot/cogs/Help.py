...
class Help(commands.Cog):
    ...
    async def get_command(self, ctx, value: str) -> str:
        ...
        if command is not None:
            ...
            if cog is None:
                embed = discord.Embed(title=f"No groups or commands by the name `{value}`", color=discord.Color.red(),
                                      description="Command categories are case-sensitive.")
                return await ctx.send(embed=embed)
            ...
            embed = discord.Embed(title=f"{cog.qualified_name} Category", color=discord.Color.random(),
    ...
    async def help(self, ctx, *, value=None):
        ...
        if value is None:
            embed = discord.Embed(title="ConchBot Commands", colour=discord.Colour.green(),
                                  description="ConchBot is a small bot trying to grow, so your support would"
                                              "be amazing! Even as much as a vote on Top.gg or DBL can help "
            ...
            embed.add_field(name="Extra Links", value="[Invite Me!](https://top.gg/bot/733467297666170980/invite/)"
                                                      "| [Support Server](https://discord.gg/PyAcRfukvc) | [Website]("
                                                      "https://conch.glitch.me) "
                                                      "| [Vote on Top.gg](https://top.gg/bot/733467297666170980/vote/)"
                                                      "| [Vote on Discord Bot List]("
                                                      "https://discordbotlist.com/bots/conchbot/upvote)",
                            inline=False)
            embed.set_footer(text="Discord ConchBot | Made by Jerrydotpy")
